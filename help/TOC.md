...
+ 通訊管道 {#communication-channels}
  ...
  + 交易型訊息傳遞功能 {#transactional-messaging}
...
+ 管理 {#administrating}
  ...
  + 設定管道 {#configuring-channels}
    ...
    + {hide-from-toc}[關於電子郵件追蹤像素的 CNIL 指引](administration/using/cnil-pixel-tracking.md)
