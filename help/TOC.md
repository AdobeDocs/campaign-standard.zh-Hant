...
+ [產品檔案](campaign-standard-home.md)
+ 發行說明 {#release-notes}
   + [發行說明](rn/using/release-notes.md)
   + [發行說明2018](rn/using/release-notes-2018.md)
   + [發行說明2017](rn/using/release-notes-2017.md)
...
+ 快速入門 {#getting-started}
   + 關於Adobe Campaign {#about-adobe-campaign}
      ...
      + [細分與定位](start/using/segmentation-and-targeting.md)
   ...
   + 行銷計畫 {#marketing-plans}
      + [方案與宣傳](start/using/programs-and-campaigns.md)
...
+ 個人檔案與受眾 {#profiles-and-audiences}
   ...
   + 瞭解選擇加入和選擇退出程式 {#understanding-opt-in-and-opt-out-processes}
      ...
      + [識別遞送的退出描述檔](audiences/using/identifying-opt-out-profiles-for-a-delivery.md)
+ 通訊頻道 {#communication-channels}
   + 關於通訊頻道 {#about-communication-channels}
      + [發現通訊頻道](channels/using/discovering-communication-channels.md)
      + [傳送訊息的關鍵步驟](channels/using/key-steps-to-send-a-message.md)
      + [訪問消息](channels/using/accessing-messages.md)
...
+ 報告 {#reporting}
   ...
   + 報表清單 {#list-of-reports}
      + [定義報表期間](reporting/using/defining-the-report-period.md)
      ...
      + [非交付項和彈回數](reporting/using/non-deliverables-and-bounces.md)
      + [開啟](reporting/using/opens.md)
      ...
      + [URL和點按串流](reporting/using/urls-and-click-streams.md)
...
+ 與Adobe cloud整合 {#integrating-with-adobe-cloud}
   ...
   + 使用Campaign和Analytics {#working-with-campaign-and-analytics}
      ...
      + [Analytics中的促銷活動維度和量度](integrating/using/campaign-dimensions-and-metrics-in-analytics.md)
   + 使用Campaign和Audience manager或People核心服務 {#working-with-campaign-and-audience-manager-or-people-core-service}
      ...
      + [布建和設定與Audience manager或People核心服務的整合](integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
   ...
   + [使用Campaign和Assets核心服務](integrating/using/working-with-campaign-and-assets-core-service.md)
   + 使用行動裝置適用的Campaign和Analytics {#working-with-campaign-and-analytics-for-mobile}
   ...
   + 使用促銷活動和觸發器 {#working-with-campaign-and-triggers}
      ...
      + [測試您的觸發器](integrating/using/testing-your-triggers.md)
      + [放棄觸發器使用案例](integrating/using/abandonment-triggers-use-cases.md)
+ 管理流程和資料 {#managing-processes-and-data}
   + 關於工作流程和資料管理 {#about-workflows-and-data-management}
      + [工作流程資料和程式](automating/using/workflow-data-and-processes.md)
   ...
   + 工作流一般操作 {#workflow-general-operation}
   ...
   + 定位活動 {#targeting-activities}
      ...
      + [交叉點](automating/using/intersection.md)
      + [排除](automating/using/exclusion.md)
      + [區段](automating/using/segmentation.md)
      + [閱讀觀眾](automating/using/read-audience.md)
      + [儲存觀眾](automating/using/save-audience.md)
      + [重複資料消除](automating/using/deduplication.md)
      + [濃縮](automating/using/enrichment.md)
   + 執行活動 {#execution-activities}
      + [關於執行活動](automating/using/about-execution-activities.md)
      + [開始和結束](automating/using/start-and-end.md)
      + [叉](automating/using/fork.md)
   ...
   + 通路活動 {#channel-activities}
      + [關於通路活動](automating/using/about-channel-activities.md)
   ...
   + 資料管理活動 {#data-management-activities}
      ...
      + [協調](automating/using/reconciliation.md)
   ...
   + 匯入和匯出資料 {#importing-and-exporting-data}
      ...
      + [定義導入模板](automating/using/defining-import-templates.md)
      + [導出日誌](automating/using/exporting-logs.md)
      + [管理包](automating/using/managing-packages.md)
      + [導出清單](automating/using/exporting-lists.md)
   + 使用案例：工作流程 {#workflow-use-case}
      + [建立具備輔助功能的傳送](automating/using/workflow-created-query-with-complement.md)
      + [在建立日期建立傳送](automating/using/workflow-creation-date-query.md)
      + [建立每週傳送](automating/using/workflow-weekly-offer.md)
      + [在位置上建立區段](automating/using/workflow-segmentation-location.md)
...
+ 開發 {#developing}
   + 關於自訂資源 {#about-custom-resources}
      ...
      + [監控資料模型更改](developing/using/monitoring-data-model-changes.md)
   + 添加或擴展資源 {#adding-or-extending-a-resource}
      + [添加資源的關鍵步驟](developing/using/key-steps-to-add-a-resource.md)
      + [建立或擴展資源](developing/using/creating-or-extending-the-resource.md)
      + [配置資源的資料結構](developing/using/configuring-the-resource-s-data-structure.md)
      ...
      + [使用複合標識鍵調用資源](developing/using/uc-calling-resource-id-key.md)
   + 使用案例：擴充API {#use-case--extending-the-api}
      + [關於擴充API](developing/using/about-extending-the-api.md)
      + [步驟1:將擴充功能欄位新增至描述檔資源](developing/using/step-1--add-extension-fields-to-the-profile-resource.md)
      + [步驟2:發佈擴充功能](developing/using/step-2--publish-the-extension.md)
      + [步驟3:驗證擴展](developing/using/step-3--verify-the-extension.md)
   + 使用案例：擴充資源 {#use-cases--extending-resources}
      + [使用新欄位擴充描述檔資源](developing/using/extending-the-profile-resource-with-a-new-field.md)
      + [將預訂擴展到應用程式資源](developing/using/extending-the-subscriptions-to-an-application-resource.md)
+ 管理 {#administrating}
   ...
   + 使用者與安全性 {#users-and-security}
      ...
      + [審核導出日誌](administration/using/auditing-export-logs.md)
   ...
   + 設定頻道 {#configuring-channels}
      ...
      + [配置事務性消息傳遞](administration/using/configuring-transactional-messaging.md)
   + 使用排版規則 {#working-with-typology-rules}
