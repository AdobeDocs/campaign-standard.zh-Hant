...
在Admin Console中管理使用者(請參閱[管理群組和使用者](../../administration/using/managing-groups-and-users.md)區段或[Admin Console檔案](https://helpx.adobe.com/tw/enterprise/managing/user-guide.html))。
