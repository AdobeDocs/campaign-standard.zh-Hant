...
在Admin Console中管理用戶(請參閱 [管理組和用戶](../../administration/using/managing-groups-and-users.md) 的 [Admin Console文檔](https://helpx.adobe.com/tw/enterprise/managing/user-guide.html))。
