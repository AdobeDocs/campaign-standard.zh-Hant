...
要確保資料收集UI中的所有配置更改都生效，必須發佈這些更改。 有關詳細資訊，請參見 [發佈](https://developer.adobe.com/client-sdks/documentation/getting-started/create-a-mobile-property/#publish-the-configuration)。
...
>[!NOTE]
>
>要將PII資訊從移動應用發送到Adobe Campaign，必須實現SDK API。 有關詳細資訊，請轉至 [收集PII](https://developer.adobe.com/client-sdks/documentation/mobile-core/api-reference/#collectpii)。
