...
* 已在24.1版本中新增支援&#x200B;**HTTP v1 API**&#x200B;模式。 如果您的環境執行於舊版，此變更的先決條件是將您的環境升級至[最新的Campaign Standard版本](../../rn/using/release-notes.md)。
...
根據Google的通知，Android推送訊息將在2024年6月20日之後開始失敗。 [閱讀更多](https://firebase.google.com/docs/cloud-messaging/migrate-v1){target="_blank"}。

+++

+++客戶完成FCMv1移轉後可移回到FCM嗎？
