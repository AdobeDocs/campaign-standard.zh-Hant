...
有關詳細資訊，請參見 [iOS生命週期擴展](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/mobile-core/lifecycle/lifecycle-extension-in-ios)。
...
有關詳細資訊，請參見 [Android生命週期擴展](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/mobile-core/lifecycle/lifecycle-extension-in-android)。
...
* **[!UICONTROL setPushIdentifier]** <br>有關詳細資訊，請參見 [setPushIdentifier](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-campaign-standard/adobe-campaign-standard-api-reference#setpushidentifier)。
...
* **[!UICONTROL trackAction]**。 有關詳細資訊，請參見 [跟蹤應用操作](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/mobile-core/mobile-core-api-reference#track-app-actions)。
...
有關詳細資訊，請參見 [跟蹤應用操作](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/mobile-core/mobile-core-api-reference#track-app-actions)。
...
* 設定連結欄位 <br>有關詳細資訊，請參見 [設定連結欄位](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-campaign-standard/adobe-campaign-standard-api-reference#set-linkage-fields)。
* 重置連結欄位 <br>有關詳細資訊，請參見 [重置連結欄位](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-campaign-standard/adobe-campaign-standard-api-reference#reset-linkage-fields)。
