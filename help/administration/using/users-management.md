...
管理員可以從Admin Console管理使用者。 然後，使用者會自動與 Adobe Campaign 同步。如需詳細資訊，請參閱 [Admin Console](https://helpx.adobe.com/tw/enterprise/using/users.html) 說明檔案。
...
1. 從 **[!UICONTROL Assign products]** 標籤，為您的使用者指派一或多個安全性群組。 如需安全性群組的詳細資訊，請參閱本[頁面](../../administration/using/managing-groups-and-users.md)。
