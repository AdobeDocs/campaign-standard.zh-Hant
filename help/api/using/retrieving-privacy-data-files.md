...
要檢索包含與協調值關聯的所有資訊的檔案，請執行以下三步步驟：

1. 執行 **POST** 請求建立具有屬性的新請求 **type=&quot;access&quot;**，請參閱 [建立新隱私請求](../../api/using/creating-a-privacy-request.md)。

1. 執行 **GET** 請求以檢索有關請求的資訊。

1. 通過執行 **POST** 返回的請求 **隱私請求資料** URL，在負載內具有隱私請求內部名稱。 例如：{ &quot;name&quot;: &quot;PT17&quot;}。

<br/>

***示例請求***

使用type=&quot;access&quot;屬性建立隱私請求。
...
它返回具有關聯URL的privacyRequestData屬性。
...
對privacyRequestData URL執行POST請求，並在負載內使用請求內部名稱。
