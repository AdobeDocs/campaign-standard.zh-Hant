...
![](assets/do-not-localize/how-to-video.png) [探索如何在影片中使用工作流程匯入設定檔](#video)
...
1. 輸入設定檔資料。
   ...
   * 此 **[!UICONTROL Access authorization]** 類別會指出設定檔的組織單位，以 [管理許可權](../../administration/using/about-access-management.md). 若要將組織欄位新增至您的設定檔，請參閱[分割設定檔](../../administration/using/organizational-units.md#partitioning-profiles)區段。
