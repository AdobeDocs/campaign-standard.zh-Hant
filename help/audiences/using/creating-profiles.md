...
![](assets/do-not-localize/how-to-video.png) [瞭解如何使用視頻中的工作流導入配置檔案](#video)
...
1. 輸入設定檔資料。
   ...
   * 的 **[!UICONTROL Access authorization]** 類別指示配置檔案的組織單位 [管理權限](../../administration/using/about-access-management.md)。 若要將組織欄位新增至您的設定檔，請參閱[分割設定檔](../../administration/using/organizational-units.md#partitioning-profiles)區段。
