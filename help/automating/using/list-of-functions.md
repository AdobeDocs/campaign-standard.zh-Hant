...
>[!NOTE]
>
>所有活動中都提供其他函式，可讓您在使用外部參數呼叫工作流程後使用事件變數。 詳細資訊於 [本節](../../automating/using/customizing-workflow-external-parameters.md).
...
<table> 
 <tbody> 
  ...
  <tr>
   <td> <strong>StringAgg</strong>，字串匯總<br /> </td>
   <td> 傳回字串類型列值的串連，以第二個引數中的字元分隔（預設分隔符號為逗號）。<br /> </td>
