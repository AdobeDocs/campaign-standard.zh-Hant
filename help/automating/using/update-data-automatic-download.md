...
1. 確認您的活動。
1. 將[載入檔案](../../automating/using/load-file.md)活動拖放到工作流程中，並將其置於&#x200B;**[!UICONTROL Transfer file]**&#x200B;活動之後。
1. 選取活動，然後使用所顯示快速動作中的 ![](assets/edit_darkgrey-24px.png) 按鈕將其開啟。
...
1. 依照先前指定的內容來設定您的活動。
1. 將[更新資料](../../automating/using/update-data.md)活動拖放到工作流程中，並將其置於&#x200B;**[!UICONTROL Load file]**&#x200B;活動之後，然後進行設定。
