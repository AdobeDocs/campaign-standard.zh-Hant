...
您可以傳送目標定位電子郵件給客戶，並在其當地商店提供產品建議。
...
1. 在&#x200B;**[!UICONTROL Activities]** > **[!UICONTROL Targeting]**&#x200B;中，拖放[查詢](../../automating/using/query.md)活動![](assets/query.png)。
1. 連按兩下此活動。
