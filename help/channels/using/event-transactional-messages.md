...
在此示例中，您將通過添加[建立事件](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message)時定義的三個欄位，瞭解如何個性化事務性消息：名字、最後咨詢的產品、購物車總量。

為此，您將[在訊息內容中插入個人化欄位](../../designing/using/personalization.md#inserting-a-personalization-field)。
...
1. 瀏覽&#x200B;**[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]**&#x200B;以取得個人化欄位：名字、最後咨詢的產品、購物車總量。
...
進一步瞭解此視訊[。](https://docs.adobe.com/content/help/zh-Hant/campaign-standard-learn/tutorials/designing-content/product-listings-in-transactional-email.translate.html)
