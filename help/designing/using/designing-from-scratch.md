...
選取編 **[!UICONTROL Preheader]** 輯方塊並完成內容。

![](assets/email_designer_preheader.png)

您可以在 **[!UICONTROL Content block]**&#x200B;前標內 **[!UICONTROL Dynamic content]** 容中 **[!UICONTROL Personalization fields]** 新增、或。
...
### **[!UICONTROL Text]**
    ...
    使用此元件在您的電子郵件中插入文字。 您可以在**[!UICONTROL Component Settings]**中調整文字的顏色、樣式和大小。

### **[!UICONTROL Divider]**

    使用此元件在電子郵件中插入分界線。 您可以在**[!UICONTROL Component Settings]**中選取分行的顏色、樣式和大小。
