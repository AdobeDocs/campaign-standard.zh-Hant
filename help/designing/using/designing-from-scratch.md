...
1. 定義您電子郵件的主旨行。 請參閱[個人化電子郵件的主旨行](../../designing/using/subject-line.md#defining-the-subject-line-of-an-email)。
1. 預覽您的電子郵件.
...
>[!NOTE]
>
>為避免從頭開始設計電子郵件內容，您可以使用現成可用的內容範本。 如需詳細資訊，請參閱[內容範本](../../designing/using/using-reusable-content.md#content-templates)。
...
1. 開啟現有內容或建立新的電子郵件內容。
1. 選擇左側的&#x200B;**+**&#x200B;表徵圖以訪問&#x200B;**[!UICONTROL Structure components]**。
...
1. 拖放您塑造電子郵件形狀所需的結構元件。
   ...
   >[!NOTE]
   >
   >請注意，欄堆並不與所有電子郵件程式相容。 不支援時，不會堆疊欄。
   >
   >一旦置入電子郵件中，您就無法移動或移除元件，除非其中已有內容元件或片段。

1. 多個由一個或多個列組成的結構元件可用。

   選擇&#x200B;**[!UICONTROL n:n column]**&#x200B;元件以定義您選擇的欄數（介於3和10之間）。 您也可以移動每欄底部的箭頭來定義每欄的寬度。
...
>title="使用前標"
>abstract="前置標題可讓您設定簡短的摘要文字，為電子郵件提供較高的開啟率。"

前置標題是從收件匣檢視電子郵件時，主旨行後面的簡短摘要文字。 預報頭可提供較高的開放率。

選擇&#x200B;**[!UICONTROL Preheader]**&#x200B;編輯框並完成內容。

![](assets/email_designer_preheader.png)

您可以在前標內容中添加&#x200B;**[!UICONTROL Content block]**、**[!UICONTROL Dynamic content]**&#x200B;或&#x200B;**[!UICONTROL Personalization fields]**。

>[!NOTE]
>
>請注意，預先標題與所有電子郵件程式不相容。 不支援時，將不會顯示預先標題。
...
使用此元件在您的電子郵件中插入文字。 您可以調整&#x200B;**[!UICONTROL Component Settings]**&#x200B;中文字的顏色、樣式和大小。

### **[!UICONTROL Divider]**

使用此元件在電子郵件中插入分界線。 可以在&#x200B;**[!UICONTROL Component Settings]**&#x200B;中選擇分行的顏色、樣式和大小。
...
>[!NOTE]
>
>免費的HTML元件可以編輯，但選項有限。 如果未插入所有樣式，請務必在HTML程式碼的&#x200B;**head**&#x200B;區段中新增正確的CSS，否則電子郵件將無法回應。 使用&#x200B;**[!UICONTROL Preview]**&#x200B;按鈕測試內容的回應速度（請參閱[預覽訊息](../../sending/using/previewing-messages.md)）。

為了讓外部內容與電子郵件設計人員相容，Adobe建議從頭開始建立訊息，並將內容從您現有的電子郵件複製到片段和元件。

當您有無法重新建立的內容時，可以使用&#x200B;**[!UICONTROL Html]**&#x200B;內容元件，從原始電子郵件複製並貼上HTML程式碼。 繼續之前，請務必熟悉HTML。
...
將視訊元件插入電子郵件的結構元件，並在&#x200B;**[!UICONTROL Component Settings]**&#x200B;中輸入視訊連結。

>[!NOTE]
>
>請注意，視訊與所有電子郵件程式不相容。 不支援時，將會顯示備援。
...
使用此元件，在電子郵件中插入社交媒體頁面的連結。 您可以選取要顯示的連結，以及&#x200B;**[!UICONTROL Component Settings]**&#x200B;中其圖示的大小。

### 轉盤{#carousel-settings}
...
1. 將&#x200B;**[!UICONTROL Carousel]**&#x200B;元件拖放至結構元件內。
1. 瀏覽以從您的電腦選取影像。

   ![](assets/des_carousel_browse.png)

1. 在&#x200B;**[!UICONTROL Settings]**&#x200B;窗格中，設定您要在轉盤中的縮圖數。
1. 從您的電腦選擇備援影像。
