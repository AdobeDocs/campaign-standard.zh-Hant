...
Adobe Campaign預設資料模型會顯示在此[區段](../../developing/using/datamodel-introduction.md)中。
...
在Adobe Campaign中建立的每個資源至少必須有一個唯一的[識別碼](../../developing/using/configuring-the-resource-s-data-structure.md#defining-identification-keys)。
