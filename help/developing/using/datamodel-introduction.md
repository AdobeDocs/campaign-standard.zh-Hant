...
| 有用的頁面 | 額外資源 |
|---|---|
| [開始使用資料模型](data-model-concepts.md) | [擴充輪廓資源](extending-the-profile-resource-with-a-new-field.md) |
| [資料模型最佳實務](data-model-best-practices.md) | [擴充訂閱資源](extending-the-subscriptions-to-an-application-resource.md) |
| [新增資源](key-steps-to-add-a-resource.md) | [擴充輪廓 API](about-extending-the-api.md) |
