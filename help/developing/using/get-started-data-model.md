...
**診斷**&#x200B;功能表可讓您列出Campaign Standard產生的技術物件：資料結構描述、網頁、篩選器等，讓您監視資料模型及其所做的任何變更。
...
此外，您可以&#x200B;**擴充Campaign Standard REST API**，以便在API擴充欄位中公開自訂資源設定檔。 舉例來說，這可讓您使用計費系統產生的促銷代碼來更新客戶的設定檔。
