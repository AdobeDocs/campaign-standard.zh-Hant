...
1. 添加 **[!UICONTROL Places]** 資料收集UI中移動應用配置的擴展。 在Adobe Campaign設定移動應用程式。 請參閱 [安裝Places擴展](https://experienceleague.adobe.com/docs/places/using/places-ext-aep-sdks/places-extension/places-extension.html#install-the-places-extension-in-adobe-experience-platform-launch)。
...
1. 在 **訪問者ID服務** 選項 **啟用** 並從下拉清單中選擇您的組織。 按一下「**儲存**」。
...
此步驟在 [使用SDK V4配置移動應用程式](https://helpx.adobe.com/tw/campaign/kb/configuring-app-sdkv4.html) 的子菜單。
