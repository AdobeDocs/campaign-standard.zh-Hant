...
* **[!UICONTROL Bidirectional]**：此選項會使 **對映** 區段。 這些配對可識別Microsoft Dynamics 365和Adobe Campaign中的哪些欄位會相互對應。 [了解更多](../../integrating/using/d365-acs-notices-and-recommendations.md)。
