...
在&#x200B;**[!UICONTROL Edit Table Mapping]**&#x200B;頁面中，檢查&#x200B;**[!UICONTROL Mappings]**&#x200B;區段，確認來自Microsoft Dynamics 365的欄位已對應至Campaign中的正確欄位。 如果您需要新增任何其他對應，請立即新增，以及任何取代或篩選器。 [了解更多資訊](../../integrating/using/d365-acs-self-service-app-data-sync.md)。
