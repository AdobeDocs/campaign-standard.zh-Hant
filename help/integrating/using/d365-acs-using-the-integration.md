...
>[!NOTE]
>
>AppSource中的Microsoft Dynamics 365 **適用的** Adobe Campaign需要安裝在您的Microsoft Dynamics 365執行個體中，才能檢視這些事件。 [了解更多資訊](../../integrating/using/d365-acs-configure-d365.md#install-appsource-app)。
...
* **映象頁面URL**：已傳送/開啟/按一下/退回之電子郵件的映象頁面URL。 您可以在對應的Campaign電子郵件通道活動的設定畫面中修改電子郵件映象頁面的到期日。 [了解更多資訊](../../administration/using/configuring-email-channel.md#validity-period-parameters)。
...
視記錄數量而定，您可能需要使用Campaign SFTP儲存空間進行初始資料傳輸。 [了解更多資訊](#initial-data-transfer)。
...
>[!NOTE]
>
>在整合應用程式UI中，**單向（Microsoft Dynamics 365至Campaign）**&#x200B;和&#x200B;**雙向**&#x200B;選擇退出使用案例是在單獨的選擇退出工作流程中設定的。 [了解更多資訊](../../integrating/using/d365-acs-self-service-app-data-sync.md#opt-in-out-wf)。
>
