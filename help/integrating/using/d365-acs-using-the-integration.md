...
>[!NOTE]
>
>此 **適用於Microsoft Dynamics 365的Adobe Campaign** AppSource中的應用程式必須安裝在Microsoft Dynamics 365執行個體中，才能檢視這些事件。 [了解更多](../../integrating/using/d365-acs-configure-d365.md#install-appsource-app)。
...
電子郵件URL點選事件的表單會為已點選的URL新增一個額外屬性：
...
根據記錄數量，您可能需要使用Campaign SFTP儲存空間進行初始資料傳輸。 [了解更多](#initial-data-transfer)。
