...
>[!NOTE]
>
>若要建立觸發器，您需要 **[!UICONTROL Administration]** 角色或 **[!UICONTROL Administrators]** 安全組。 有關詳細資訊，請參閱 [頁面](../../administration/using/list-of-roles.md).
...
1. 您現在可以發佈觸發器。 有關詳細資訊，請參閱 [在Campaign中發佈觸發程式](../../integrating/using/using-triggers-in-campaign.md#publishing-trigger-in-campaign).

## 在Campaign中發佈觸發程式 {#publishing-trigger-in-campaign}

根據現有的Adobe Experience Cloud觸發程式在Adobe Campaign中建立觸發程式事件後，您現在需要發佈它。

1. 在您先前建立的觸發器中，按一下 **[!UICONTROL Publish]** 按鈕，開始發佈觸發器事件。
...
1. 發佈完成後，下列訊息會顯示在 **[!UICONTROL Publication]**.
