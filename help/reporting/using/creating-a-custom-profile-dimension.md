...
1. 輸入 **[!UICONTROL Label]** 和 **[!UICONTROL Value]** 然後按一下 **[!UICONTROL Add]**. 在此範例中，我們需要建立金、銀和銅的值。 完成時，按一下&#x200B;**[!UICONTROL Confirm]**。

   ![](assets/custom_profile_14.png)

1. 選取 **[!UICONTROL Screen definition]** 索引標籤。在 **[!UICONTROL Detail screen configuration]** 下拉式清單，勾選 **[!UICONTROL Add personalized fields]** 區段，以在我們的設定檔中建立新區段。
...
1. Check **[!UICONTROL Add this field in Dynamic reporting as a new dimension]** 以建立您的自訂設定檔維度。
   ...
   只有接受PII視窗時，才能使用此選項。 如需關於此項目的詳細資訊，請參閱此[頁面](../../reporting/using/about-dynamic-reports.md#dynamic-reporting-usage-agreement)。
