...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> @uniqueimpressions<br /> </td> 
   <td> @unique(@count(status=view))<br /> </td> 
   <td> 的 <span class="uicontrol">根據其Campaign設定檔定位使用者(inAppProfile)</span> 範本，使用者=收件者ID。<br /> 的 <span class="uicontrol">鎖定行動應用程式的所有使用者(inAppBroadcast)</span> 和 <span class="uicontrol">根據行動設定檔定位使用者(inApp)</span> 範本，使用者= MC ID或同等專案，代表使用者、行動應用程式和裝置的獨特組合。<br /> </td> 
  </tr> 
  <tr> 
   <td> 應用程式內點選次數 <br /> </td> 
  ...
  <tr> 
   ...
   <td> Button 1或Button 2的總點按次數/曝光總數*100<br /> </td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td> 應用程式內解除<br /> </td> 
