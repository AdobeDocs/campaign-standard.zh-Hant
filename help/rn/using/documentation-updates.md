...
現在不建議使用與Adobe Experience Platform資料連接器和受眾目標服務的整合。 [閱讀全文](deprecated-features.md)

SMTPtest模式的使用已詳細說明。 [閱讀全文](../../administration/using/configuring-email-channel.md#smtp-test-mode)
