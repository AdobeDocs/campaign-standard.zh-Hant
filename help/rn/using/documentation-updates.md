...
API檔案已更新，其中包含 **History** API的資訊。 已新增使用案例，說明如何擷取傳送至描述檔的傳送鏡像頁面。 [閱讀更多資訊](../../api/using/interacting-with-marketing-history.md)
...
在API檔案中新增與自訂篩選器相關 **的區段**。 [閱讀更多資訊](../../api/using/filtering.md)
