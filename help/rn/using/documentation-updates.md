...
本節將討論如何與Adobe Experience PlatformSources和Destinations合作，在Campaign Standard和Adobe即時客戶資料平台(RTCDP)之間共用資料。 [顯示全文](../../integrating/using/get-started-sources-destinations.md)
