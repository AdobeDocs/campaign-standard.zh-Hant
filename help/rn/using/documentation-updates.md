...
已新增與「促銷活動標準」設定相關的新區段。 [閱讀更多資訊](../../administration/using/about-campaign-standard-settings.md)
...
推播通知區段中新增了一個區段，說明如何根據行動應用程式訂閱資料建立和更新個人檔案資訊。 [閱讀更多資訊](../../channels/using/updating-profile-with-mobile-app-data.md)
...
新增了有關工作流程的使用案例，著重於查詢的新區段。 [閱讀更多資訊](../../automating/using/workflow-created-query-with-complement.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-17}
...
已新增動態報表的疑難排解。 [閱讀更多資訊](../../reporting/using/troubleshooting.md)

說明已新增不同應用程式內範本如何處理個人資訊的圖表。 [閱讀更多資訊](../../channels/using/preparing-and-sending-an-in-app-message.md)

有關如何將電子郵件內容儲存為電子郵件設計工具中片段的章節已經更新。 [閱讀更多資訊](../../designing/using/using-reusable-content.md#saving-content-as-a-fragment)
...
在自訂資源檔案中新增警告。 我們建議對自訂資源ID使用最多30個字元。 這也適用於自訂資源欄位、索引和連結。 [閱讀更多資訊](../../developing/using/creating-or-extending-the-resource.md)
...
已新增建議，說明在呼叫含參數的工作流程時，如何使用無匯總期間的循環傳送。 [閱讀更多資訊](../../automating/using/calling-a-workflow-with-external-parameters.md)
...
「網域名稱委派」文章已更新。 [閱讀更多資訊](https://helpx.adobe.com/campaign/kb/domain-name-delegation.html)

已發佈新的「發行計畫」文章，以分享即將發行的發行日期。 [閱讀更多資訊](https://helpx.adobe.com/campaign/kb/acs-release-planning.html)
...
已 [更新REST API](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html) 檔案：
...
已新增有關新測試活 **動的資** 訊。 [閱讀更多資訊](../../automating/using/test.md)

「自動化」指南已更新，其中包含相關工作流程活動的連結。 [閱讀更多資訊](../../automating/using/workflow-interface.md#palette)

「動態」報表的「指標」計算區段已更新。 [閱讀更多資訊](../../reporting/using/indicator-calculation.md)

已新增動態報表相容性表格，以更好地瞭解維度與度量之間的相容性。 [閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)

工作流程的函式清單已更新。 [閱讀更多資訊](../../automating/using/list-of-functions.md)

「設計內容」章節已重新整理並改良，新章節清楚說明使用現有內容使用「電子郵件設計人員」來設計電子郵件的不同方法。 [閱讀更多資訊](../../designing/using/using-existing-content.md)

新增了如何將電子郵件內容儲存為電子郵件設計工具中片段的新章節。 [閱讀更多資訊](../../designing/using/using-reusable-content.md#saving-content-as-a-fragment)

「管理連結」區段已更新，內含如何在「電子郵件設計器」中管理追蹤URL的其他資訊。 [閱讀更多資訊](../../designing/using/links.md#inserting-a-link)

已添加新部分，以說明特定事務性消息重試過程。 [閱讀更多資訊](../../channels/using/event-transactional-messages.md#transactional-message-retry-process)
...
Dreamweaver整合區段已更新並改良。 [閱讀更多資訊](../../designing/using/using-integrations.md#editing-content-in-dreamweaver)
...
新增了比較Adobe Campaign中不同電子郵件撰寫選項的章節。 [閱讀更多資訊](../../designing/using/using-integrations.md#email-design-options-comparison)
...
有關如何添加或擴展資源的章節已經更新。 [閱讀更多資訊](../../developing/using/creating-or-extending-the-resource.md)

新增了如何擴充描述檔自訂資源的使用案例。 [閱讀更多資訊](../../developing/using/extending-the-profile-resource-with-a-new-field.md)
...
已更新「觸發器——促銷活動」整合檔案。 [閱讀更多資訊](../../integrating/using/about-adobe-experience-cloud-triggers.md)

更新直接從Adobe Campaign取得的上下文說明連結。

在包含拒絕的檔案名稱中添加時間戳的附註。 [閱讀更多資訊](../../automating/using/load-file.md#configuration)

已新增匯入由長度固定的欄組成欄位時的資訊。 [閱讀更多資訊](../../automating/using/load-file.md#configuration)

已新增選項的相關資訊，讓您將拒絕項目保留在檔案中。 此選項現在可讓您將後處理階段套用至包含拒絕的檔案。 [閱讀更多資訊](../../automating/using/load-file.md#configuration)

已新增有關如何透過複製貼上作業複製工作流程活動的新區段。 [閱讀更多資訊](../../automating/using/workflow-interface.md#duplicating-workflow-activities)
...
在「更新資料」活動區段中新增新的「批次大小」欄位的資訊，可讓您定義要上傳之資料的最大批次大小。 [閱讀更多資訊](../../automating/using/update-data.md#configuration)

在「擷取檔案」活動區段中新增新選項的資訊，讓您在傳出轉場為空時停用檔案產生程式。 [閱讀更多資訊](../../automating/using/extract-file.md#configuration)
...
已新增有關Adobe Campaign中不同對象類型的詳細資訊。 [閱讀更多資訊](../../audiences/using/about-audiences.md)

更新「使用者與安全性」一章，以反映地理單位的折舊。 [閱讀更多資訊](../../administration/using/organizational-units.md)

已新增「載入資料」活動中新選項的相關資訊，可讓您將後處理階段套用至包含已拒絕記錄的檔案(例如： 壓縮郵遞區號格式)。 [閱讀更多資訊](../../automating/using/load-file.md)

已新增「更新資料」活動中新欄位的資訊，可讓您設定要上傳之資料的最大批次大小。 [閱讀更多資訊](../../automating/using/update-data.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-3}

已更新推播通知指南，並變更介面。 [閱讀更多資訊](../../channels/using/about-push-notifications.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-4}

已新增有關SMS連接器通訊協定和設定的新技術。 [閱讀更多資訊](https://helpx.adobe.com/campaign/kb/sms-connector-protocol-and-settings.html)
...
API檔案已更新，其中包含 **History** API的資訊。 已新增使用案例，說明如何擷取傳送至描述檔的傳送鏡像頁面。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#how-to-retrieve-the-mirror-page-for-a-delivery-sent-to-a-profile)

### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-5}

已更新並重新整理「觸發器——促銷活動」整合檔案。 [閱讀更多資訊](../../integrating/using/about-adobe-experience-cloud-triggers.md)

新增如何建立自訂描述檔維度的逐步使用案例。 [閱讀更多資訊](../../reporting/using/creating-a-custom-profile-dimension.md)

已重新組織「使用促銷活動和觀眾管理員」或「人員」核心服務檔案。 [閱讀更多資訊](../../integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)

已更新「準備傳送」角色定義。 [閱讀更多資訊](../../administration/using/list-of-roles.md)

在查詢活動區段中新增範例，說明如何定位在傳送中點按特定連結的描述檔。 [閱讀更多資訊](../../automating/using/query.md#targeting-profiles-who-clicked-a-specific-link-)

在API檔案中新增與自訂篩選器相關 **的區段**。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#filtering)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-6}

已新增在Analytics中找到的促銷活動度量清單。 [閱讀更多資訊](../../integrating/using/campaign-dimensions-and-metrics-in-analytics.md)

已新增「管理」功能表中「授權」選項的資訊。 [閱讀更多資訊](../../administration/using/licenses.md)

已新增如何在推播通知中使用自訂欄位的資訊。 [閱讀更多資訊](../../channels/using/customizing-a-push-notification.md#add-custom-fields)

更新傳送最佳實務逐步指南。 [閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

已新增追蹤記錄檔類型的資訊。 [閱讀更多資訊](../../sending/using/tracking-messages.md#tracking-logs)

查詢活動節已用查詢示例更新。 [閱讀更多資訊](../../automating/using/query.md#query-samples)

黑名單專用的章節已更名為「瞭解加入和退出程式」。 它已更新，其中包含如何管理特定頻道的選擇加入，以及如何設定著陸頁面以管理選擇加入和選擇退出的資訊。 [閱讀更多資訊](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)

瞭解使用Adobe代管SFTP伺服器的最佳實務。 [閱讀更多資訊](../../administration/using/external-accounts.md#sftp-external-account)
...
GDPR API會重新分組允許自動處理GDPR要求的功能。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#gdpr-api)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-8}
...
新增如何使用SMS自動回覆的逐步使用案例。 [閱讀更多資訊](../../channels/using/managing-incoming-sms.md#managing-stop-sms)
...
已更新有關傳送失敗和隔離的資訊。 [閱讀更多資訊](../../sending/using/monitoring-a-delivery.md)
...
API Signal活動觸發——詳 [細資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity)

### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-9}

已更新服務建立部分。 [閱讀更多資訊](../../audiences/using/creating-a-service.md)

已新增使用案例，以便更好地瞭解安全群組和裝置。 [閱讀更多資訊](../../administration/using/organizational-units.md)

改進動態報表中維度、量度和區段的定義和計算。 [閱讀更多資訊](../../reporting/using/list-of-components-.md)

已新增有關使用工作流程擷取傳入SMS訊息的資訊。 [閱讀更多資訊](../../administration/using/configuring-sms-channel.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-10}

更新A/B測試範例。 [閱讀更多資訊](../../channels/using/designing-an-a-b-test-email.md)

有關如何在行動應用程式傳送「收集PII」資料時建立或更新描述檔資料的新技術。 [閱讀更多資訊](https://helpx.adobe.com/campaign/kb/acs-updating-profile-based-on-subscription.html)
...
透過API專用於工作流程管理的新區段。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#workflows-and-api)

新區段專用於主要金鑰，以及使用商業ID做為API中金鑰。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#primary-key)

在API中新增有關簡單和多重篩選的資訊。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#filtering)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-11}

「動態報表」中每個可用元件的詳細清單，以及公式的某些變更。 [閱讀更多資訊](../../reporting/using/list-of-components-.md)
...
已更新不同使用者類型的相關章節。 [閱讀更多資訊](../../administration/using/users-management.md)

更新影像來源個人化的相關章節。 [閱讀更多資訊](../../designing/using/personalization.md#personalizing-an-image-source)

在作用中描述檔報表上新增的檔案。 [閱讀更多資訊](../../audiences/using/active-profiles.md)
...
ACS ID上添加的文檔。 [閱讀更多資訊](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

新增加了新的加密和雜湊函式，並附上範例。 [閱讀更多資訊](../../automating/using/list-of-functions.md)

已更新「傳輸檔案」工作流程活動的章節。 [閱讀更多資訊](../../automating/using/transfer-file.md)

在「電子郵件傳送」工作流程活動中「傳送訊息前請求確認」選項中新增的資訊。 [閱讀更多資訊](../../automating/using/email-delivery.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-12}
...
報告指標計算表已更新。 [閱讀更多資訊](../../reporting/using/indicator-calculation.md)

報告檔案已更新為4個新量度。 [閱讀更多資訊](../../reporting/using/list-of-components-.md)

在描述檔的唯一ID產生中新增檔案。 [閱讀更多資訊](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

現在，透過逐步程式記錄雙重加入機制。 [閱讀更多資訊](../../channels/using/setting-up-a-double-opt-in-process.md)

「角色清單」(List of roles)部分已更新。 [閱讀更多資訊](../../administration/using/list-of-roles.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-13}
...
已更新如何在Campaign中處理影像的章節。 [閱讀更多資訊](../../designing/using/images.md#setting-up-image-properties)

已更新與Adobe Analytics for Mobile（興趣點）的整合，包括設定步驟和使用案例。 [閱讀更多資訊](../../integrating/using/about-campaign-points-of-interest-data-integration.md)
...
### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-15}

觸發器整合：新增了兩個使用案例。 [閱讀更多資訊](../../integrating/using/abandonment-triggers-use-cases.md)

我們重新設計了開發人員API檔案，提供新資訊和程式碼片段，以改善使用體驗。 [閱讀更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)
...
Transactional Messaging API —— 閱讀 [更多資訊](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)

交易式訊息的行銷功能——詳 [細內容](../../channels/using/profile-transactional-messages.md)

### 此版本隨附的其他檔案更新 {#other-documentation-updates-coming-with-the-release-16}
...
### 發行隨附的檔案更新 {#documentation-updates-coming-with-the-release}

新檔案首頁和全新的外觀和感覺。

瞭解使用者權限：已新增使用案例。 另請參考使 [用者權限表](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)。

使用API:已 [新增API擴充功能使用案例](../../developing/using/about-extending-the-api.md) 。 另請參閱 [API檔案](https://final-docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)。
...
有關電子郵件發送參數和SMTP的資訊。 [閱讀更多資訊](../../administration/using/configuring-email-channel.md#email-channel-parameters)

新的主題行資料匯入介面——詳 [細內容](../../designing/using/subject-line.md#predictive-subject-line)

在工作流程中建立推播通知傳送——詳 [細資訊](../../automating/using/push-notification-delivery.md)

「整合」指南中已更新相容性矩陣。 [閱讀更多資訊](../../integrating/using/about-campaign-integrations.md)

「使用者與安全性」區段中已新增角色。 [閱讀更多資訊](../../administration/using/list-of-roles.md)

推播通知範本——閱 [讀更多](../../channels/using/preparing-and-sending-a-push-notification.md)

SMS傳送區段已更新以反映介面變更。 [閱讀更多資訊](../../channels/using/creating-an-sms-message.md)
...
交易式訊息的後續訊息——詳 [細內容](../../channels/using/follow-up-messages.md)

Extended Profile &amp; Services API —— 詳細 [資訊](../../developing/using/updating-the-database-structure.md#publishing-a-resource-with-api-extension)

## 發行版本16.9 - 2016年9月 {#release-16-9---september-2016}

### 發行中包含的新功能 {#new-capabilities-included-in-the-release-18}

Marketing cloud觸發器——詳 [細資訊](../../integrating/using/about-adobe-experience-cloud-triggers.md)

事務性消息：暫停／取消發佈——詳 [細內容](../../channels/using/event-transactional-messages.md#unpublishing-a-transactional-message)

多品牌——閱 [讀更多](../../administration/using/branding.md)

互動式電子郵件設計預覽- [閱讀更多](../../sending/using/previewing-messages.md)

推播通知- [閱讀更多](../../channels/using/about-push-notifications.md)
