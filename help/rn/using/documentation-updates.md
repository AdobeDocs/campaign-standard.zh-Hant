...
seo-title: 文件更新
description: 文件更新
seo-description: 瞭解Adobe Campaign Standard文件的所有最新更新。
page-status-flag: 從未啓動
uuid: 3bdc7d11-8421-4110-a5 ba-7b1376 a03 dda
contentOwner: saviat
products: SG_ CAMPAIGN/STANDARD
audience: rn
content-type: reference
topic-tags: campaign-standard-release
discoiquuid: dce9711-7fa6-4773-ba21-1d54 cda20 c05
internal: n
snippet: y
...
已發佈新的版本規劃文章，以分享即將發行的發行日期。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/acs-release-planning.html)
...
* 新增了一個新區段，其中包含使用Campaign Standard REST API的一般資訊。
* 已提供預先設計的API請求集合，代表常用的使用案例。
* 新增了一個新章節，說明如何管理組織單位。
* 已新增有關如何建立服務的資訊。
...
動態報表的指標計算區段已更新。[閱讀更多資訊](../../reporting/using/indicator-calculation.md)

已新增動態報告相容性表格，進一步瞭解維度與度量之間的相容性。[閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)

工作流程的函數清單已更新。[閱讀更多資訊](../../automating/using/list-of-functions.md)

「設計內容」章節已重新整理並改進，新章節說明清楚說明不同方法，以使用現有內容來設計電子郵件設計人員。[閱讀更多資訊](../../designing/using/about-email-content-design.md#designing-an-email-using-existing-contents)

新增有關如何將電子郵件內容儲存為電子郵件設計人員中片段的新章節。[閱讀更多資訊](../../designing/using/defining-the-email-structure.md#saving-content-as-a-fragment)

「管理連結」區段已更新，提供如何在電子郵件設計工具中管理追蹤URL的額外資訊。[閱讀更多資訊](../../designing/using/inserting-a-link.md)

已新增一個新章節，說明特定交易訊息重試程序。[閱讀更多資訊](../../channels/using/event-transactional-messages.md#transactional-message-retry-process)

「使用API延伸模組發佈資源」已透過最新UI變更加以釐清和更新。[閱讀更多資訊](../../developing/using/updating-the-database-structure.md#publishing-a-resource-with-api-extension)

封存電子郵件區段已重新命名並重新組織。[閱讀更多資訊](../../administration/using/configuring-email-channel.md#archiving-emails)

「建立電子郵件」區段已更新，以反映最新介面變更。[閱讀更多資訊](../../channels/using/creating-an-email.md)

[SMS連接器通訊協定和設定](https://helpx.adobe.com/campaign/kb/sms-connector-protocol-and-settings.html) 知識庫文章已新增至SMS外部帳戶中的新選項，以限制連線至SMPP供應商的MTA實例數目。

「Get Started Guide」(快速入門手冊)已經過豐富和重新整理。[閱讀更多資訊](../../start/using/campaign-orchestration.md)

已過時和移除的功能頁面已更新。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/acs-deprecated-and-removed-features.html)
...
已新增有關交易訊息限制的新章節。[閱讀更多資訊](../../channels/using/about-transactional-messaging.md#transactional-messaging-limitations)

新增了比較Adobe Campaign中不同電子郵件編寫選項的新區段。[閱讀更多資訊](../../designing/using/about-email-content-design.md#email-design-options-comparison)

「建立自訂內容區塊」區段已增強，並詳細說明定位維度。[閱讀更多資訊](../../designing/using/adding-a-content-block.md#creating-custom-content-blocks)

已新增警告，指出電子郵件設計人員不支援Internet Explorer11。[閱讀更多資訊](../../start/using/compatible-browsers.md)

已將重新草擬的影響警告新增至刪除資源區段。[閱讀更多資訊](../../developing/using/deleting-a-resource.md)

新增或擴充資源的章節已更新。[閱讀更多資訊](../../developing/using/creating-or-extending-the-resource.md)

已新增如何擴充描述檔自訂資源的使用案例。[閱讀更多資訊](../../developing/using/extending-the-profile-resource-with-a-new-field.md)
...
已新增新的技術附註，說明如何從Adobe Campaign Standard推播通知顯示影像。[閱讀更多資訊](https://helpx.adobe.com/content/help/en/campaign/kb/display-image-push.html)

已新增推播追蹤實施的新技術附註。[閱讀更多資訊](https://helpx.adobe.com/content/help/en/campaign/kb/push-tracking.html)
...
觸發項目-促銷活動整合文件已更新。[閱讀更多資訊](../../integrating/using/about-adobe-experience-cloud-triggers.md)

直接從Adobe Campaign更新上下文說明連結。

新增附註，在包含ts的檔案名稱中加上時間戳記。[閱讀更多資訊](../../automating/using/load-file.md#configuration)

已新增資訊，匯入由具有固定長度之欄的欄位。[閱讀更多資訊](../../automating/using/load-file.md#configuration)

已新增可讓您將檔案保留在檔案中的選項。此選項現在可讓您將處理後階段套用至包含拒絕的檔案。[閱讀更多資訊](../../automating/using/load-file.md#configuration)
...
更新「使用者與安全性」章節，以反映地理單位的折舊。[閱讀更多資訊](../../administration/using/organizational-units.md)

已新增「載入資料活動」中新選項的資訊，可讓您將處理後階段套用至包含已拒絕記錄的檔案(例如：壓縮格式壓縮)。[閱讀更多資訊](../../automating/using/load-file.md)
...
更新使用者的類型。[閱讀更多資訊](../../administration/using/types-of-users.md)
...
已新增有關如何刪除對象的資訊。[閱讀更多資訊](../../audiences/using/creating-audiences.md#deleting-audiences)
...
更新Experience Manager與Adobe Campaign文件的整合。[閱讀更多資訊](../../reporting/using/creating-a-custom-profile-dimension.md)

「設計內容」指南已全面重新整理，尤其提供兩個編輯器，讓您設計電子郵件內容。[閱讀更多資訊](../../designing/using/about-email-content-design.md)
...
針對如何建立自訂描述檔維度，新增逐步使用案例。[閱讀更多資訊](../../reporting/using/creating-a-custom-profile-dimension.md)

重新組織「使用促銷活動與對象管理員」或「人員核心服務文件」。[閱讀更多資訊](../../integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)

更新「準備傳遞」角色定義。[閱讀更多資訊](../../administration/using/list-of-roles.md)
...
已在「管理」功能表中的「授權」選項中新增資訊。[閱讀更多資訊](../../administration/using/licenses.md)

已新增有關如何在推播通知中使用自訂欄位的資訊。[閱讀更多資訊](../../channels/using/customizing-a-push-notification.md#add-custom-fields)

更新傳送最佳實務逐步指南。[閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

已新增有關追蹤記錄類型的資訊。[閱讀更多資訊](../../sending/using/tracking-messages.md#tracking-logs)

查詢活動區域已更新為查詢範例。[閱讀更多資訊](../../automating/using/query.md#query-samples)

列入黑名單的區段已重新命名為「瞭解選擇加入和退出程序」。它已更新，以說明如何管理特定頻道的選擇加入，以及如何設定著陸頁面來管理選擇加入和退出。[閱讀更多資訊](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)

瞭解使用Adobe代管SFTP伺服器的最佳實務。[閱讀更多資訊](../../administration/using/external-accounts.md#sftp-external-account)

已更新支援Analytics SKU的Analytics SKU清單。[閱讀更多資訊](../../integrating/using/configuring-triggers-in-experience-cloud.md#configuring-solutions-and-services)
...
已新增有關如何設定著陸頁面的資訊，讓收件人能夠列入黑名單。[閱讀更多資訊](../../audiences/using/managing-opt-in-and-opt-out-in-campaign.md)

[「設定交易訊息](../../administration/using/configuring-transactional-messaging.md) 」區段已重新整理，並已新增 [逐步使用案例](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message) 。
...
更新排程器活動區段。[閱讀更多資訊](../../automating/using/scheduler.md)

更新Campaign和Adobe解決方案整合相關說明資料清單。[閱讀更多](../../integrating/using/about-campaign-integrations.md)資訊。
...
包含授權清單的區段已移除。[閱讀更多](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf) (PDF)。

已針對如何使用SMS自動回覆新增逐步使用案例。[閱讀更多資訊](../../channels/using/managing-incoming-sms.md#managing-stop-sms)
...
新增使用案例，以便更深入瞭解安全性群組和單位。[閱讀更多資訊](../../administration/using/organizational-units.md)

改進動態報表中維度、度量和區段的定義和計算。[閱讀更多資訊](../../reporting/using/list-of-components-.md)

已新增有關使用工作流程擷取傳入SMS訊息的資訊。[閱讀更多資訊](../../administration/using/configuring-sms-channel.md)

已新增有關轉讓檔案活動之歷史設定的資訊。[閱讀更多資訊](../../automating/using/transfer-file.md)
...
當行動應用程式傳送「匯整PII」資料時，關於如何建立或更新描述檔資料的新技術附註。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/acs-updating-profile-based-on-subscription.html)

新增關於新匯出追蹤功能的章節。[閱讀更多資訊](../../administration/using/auditing-export-logs.md)

已新增立即可用套件匯出的精確度。[閱讀更多資訊](../../automating/using/managing-packages.md)

已更新外部帳戶定義和範例。[閱讀更多資訊](../../administration/using/external-accounts.md)

已更新許多螢幕擷取，以反映查詢編輯器類別中的變更。
...
主要索引鍵的新區段，以及在API中使用業務ID作為索引鍵。[閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#primary-key)
...
新動態報表視訊。[閱讀更多資訊](../../start/using/how-to-videos.md)

新增S帳戶建議。[閱讀更多資訊](../../administration/using/external-accounts.md#amazon-s3-account-recommendations)

已更新有關不同類型使用者的章節。[閱讀更多資訊](../../administration/using/types-of-users.md)

已更新有關影像來源個人化的章節。[閱讀更多資訊](../../designing/using/personalizing-an-image-source.md)

在作用中設定檔報告中新增的文件。[閱讀更多資訊](../../audiences/using/active-profiles.md)

[傳送警報](../../sending/using/receiving-alerts-when-failures-happen.md#delivery-alerting-reasons) 文件已更新為疑難排解章節，顯示您在接收警報時可採取的動作。

現已推出新的快速入門指南：其中提供一些可用於Adobe Campaign的最佳實務，從建立和定位到傳送和監控。[閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

後續的訊息文件已更新，使用案例改善。[閱讀更多資訊](../../channels/using/follow-up-messages.md#sending-a-follow-up-message)

在ACS ID上新增文件。[閱讀更多資訊](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

新的加密和雜湊功能新增了範例。[閱讀更多資訊](../../automating/using/list-of-functions.md)

已更新有關轉讓檔案工作流程活動的章節。[閱讀更多資訊](../../automating/using/transfer-file.md)
...
電子郵件轉換文件已更新。[閱讀更多資訊](../../sending/using/email-rendering.md)

報表指標計算表格已更新。[閱讀更多資訊](../../reporting/using/indicator-calculation.md)

報告文件已更新為個新度量。[閱讀更多資訊](../../reporting/using/list-of-components-.md)

設定檔唯一ID產生時新增的說明文件。[閱讀更多資訊](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

現在，兩個選擇加入機制會透過逐步程序記錄在案。[閱讀更多資訊](../../channels/using/setting-up-a-double-opt-in-process.md)
...
現已推出新的技術註解：「將Adobe Mobile SDK與您的行動應用程式整合」。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/integrate-mobile-sdk.html)

已更新設定人員核心服務或Audience Manager整合Adobe Campaign的指示。[閱讀更多資訊](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)

已修訂授權表格，使特定角色「函數」更清晰。[閱讀更多資訊](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)
...
區段新增至不同類型的Adobe Campaign使用者。[閱讀更多資訊](../../administration/using/types-of-users.md)
...
關於Adobe Mobile Services設定的新專屬章節，以使用Adobe Campaign中的推播通知和興趣點資料。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

已更新行動應用程式設定和實施區段，包括設定和傳送推播通知的詳細步驟。[閱讀更多資訊](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

已更新如何在Campaign中處理影像的章節。[閱讀更多資訊](../../designing/using/setting-up-image-properties.md)
