...
<tr> 
<td>
<p>在2021年12月對Apache log4j v2.17.0版進行更新後，為確保我們的客戶不會因在正常發佈計畫之外對系統進行進一步更改而受到意外影響，我們已在內部進行了更新，並準備好隨此版本進行部署。</p>
</td> 
</tr> 
</tbody> 
</table>
...
* 增強訪問應用程式和伺服器配置檔案的安全性：JavaScript檔案訪問API安全性現在僅限於沙盒目錄。 (CAMP-49411)
...
* 為了優化傳輸能力，現在使用7位編碼而不是8位編碼發送電子郵件。 這防止了在從8位轉換為7位時中繼使DKIM簽名失效。 (CAMP-49016)
