...
![](assets/do-not-localize/cp-icon.png) **新控制面板 1 月版本**&#x200B;具有輸送量及延遲監視。 [了解更多資訊](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=zh-Hant)。
