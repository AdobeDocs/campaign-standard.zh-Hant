...
![](assets/do-not-localize/cp-icon.png) **新建控制面板1月版** 具有吞吐量和延遲監視。 [了解更多](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=zh-Hant)。
