...
* [管理類型](../../sending/using/about-typology-rules.md#managing-typologies)
* [類型學規則](../../sending/using/about-typology-rules.md#typology-rules)
...
1. 在標籤 **[!UICONTROL Application criteria]** 中，您可以選擇將此規則應用於所有交貨，或根據要發送的消息限制規則的適用性。 只有在符合應用程式條件時，才會執行規則。 例如，您只能對標籤以特定字詞開頭或ID包含特定字母的訊息套用規則。 請參 [閱限制篩選規則的適用性](../../sending/using/filtering-rules.md#restricting-the-applicability-of-a-filtering-rule)。

   ![](assets/fatigue20.png)

1. 選取標 **[!UICONTROL Typologies]** 簽，並將您的排版規則連結至傳送時使用的排版。 請參 [閱管理類](../../sending/using/about-typology-rules.md#managing-typologies) 型 [和類型規則](../../sending/using/about-typology-rules.md#typology-rules)。
...
執行規則時，會同時考慮過去的傳送和已排程的傳送。 這保證在給定的滑動週期內，閾值不會超過。
