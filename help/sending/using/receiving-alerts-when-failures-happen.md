...
1. 選取 **[!UICONTROL Edit properties]** 按鈕。在標籤 **[!UICONTROL Criteria parameters]** 中，定義如何套用標準。 請參 [閱標準參數](#criteria-parameters)。
...
若要檢視每次傳送發生的記錄，請選取標 **[!UICONTROL Sending logs]** 簽。 它包含已傳送訊息的清單及其狀態。 您可以在此處檢查每個收件者( **[!UICONTROL Sent]**、 **[!UICONTROL Pending]**、 **[!UICONTROL Failed]**&#x200B;等)的傳送狀態。 For more on this, see [Sending logs](../../sending/using/monitoring-a-delivery.md#sending-logs).
