...
Campaign standard提供數種工具來協助您擴充行銷資料庫。 本節詳細說明您可使用各種方法將資料插入Campaign，並參考專用檔案。
...
如需如何使用API的詳細資訊，請參閱專用 [檔案](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)。
